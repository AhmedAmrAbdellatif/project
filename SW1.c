...
//GPIO_PORTF_IEV_R &= ~0x10;   // PF4 falling edge event  " Falling = switch down or switch up ?? "
GPIO_PORTF_ICR_R = 0x10;     // clear flag4
GPIO_PORTF_IM_R |= 0x10;     // arm interrupt on PF4
NVIC_PRI7_R = (NVIC_PRI7_R&0xFF00FFFF)|0x00A00000;  // (g) priority 5 "can be changed"
